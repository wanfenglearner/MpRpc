...
class Rpcheader :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:Header.Rpcheader) */ {
 public:
  Rpcheader();
  virtual ~Rpcheader();
...
inline const std::string& Rpcheader::server_name() const {
  // @@protoc_insertion_point(field_get:Header.Rpcheader.server_name)
  return _internal_server_name();
}
inline void Rpcheader::set_server_name(const std::string& value) {
  _internal_set_server_name(value);
  // @@protoc_insertion_point(field_set:Header.Rpcheader.server_name)
}
inline std::string* Rpcheader::mutable_server_name() {
  // @@protoc_insertion_point(field_mutable:Header.Rpcheader.server_name)
...
inline void Rpcheader::set_server_name(std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:Header.Rpcheader.server_name)
}
inline void Rpcheader::set_server_name(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:Header.Rpcheader.server_name)
}
inline void Rpcheader::set_server_name(const void* value, size_t size) {
  
  server_name_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:Header.Rpcheader.server_name)
}
...
inline std::string* Rpcheader::release_server_name() {
  // @@protoc_insertion_point(field_release:Header.Rpcheader.server_name)
...
inline void Rpcheader::set_allocated_server_name(std::string* server_name) {
  ...
  // @@protoc_insertion_point(field_set_allocated:Header.Rpcheader.server_name)
}
